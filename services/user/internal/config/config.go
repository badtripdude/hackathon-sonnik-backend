...
type Config struct {
	...
	RSAPrivateKeyPath string        `env:"RSA_PRIVATE_KEY_PATH" envDefault:"/keys/app_private.pem"`
	RSAPublicKeyPath  string        `env:"RSA_PUBLIC_KEY_PATH" envDefault:"/keys/app_public.pem"`
